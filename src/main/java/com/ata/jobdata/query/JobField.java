...
public enum JobField {
    ...
    YEARS_AT_EMPLOYER_RAW("years_at_employer_raw", Type.STRING, JobRecord::yearsAtEmployerRaw),
    YEARS_OF_EXPERIENCE("years_of_experience", Type.NUMBER, JobRecord::yearsOfExperience),
    YEARS_OF_EXPERIENCE_RAW("years_of_experience_raw", Type.STRING, JobRecord::yearsOfExperienceRaw),
